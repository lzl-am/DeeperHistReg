...
# region 定义路径
source_path = "../../test/2025-03-05_15_04_40.svs"
target_path = "../../test/F2025-00089.svs"
output_path = "../../test/ihc2he_output"  # 输出目录
# endregion
...
delete_temporary_results: bool = True         # 保留临时结果（调试用）
